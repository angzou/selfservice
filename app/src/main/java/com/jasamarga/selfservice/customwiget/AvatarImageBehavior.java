...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<ShapedImageView> {
    ...
    @Override
    public boolean layoutDependsOn(CoordinatorLayout parent, ShapedImageView child, View dependency) {
        return dependency instanceof Toolbar;
    }

    @Override
    public boolean onDependentViewChanged(CoordinatorLayout parent, ShapedImageView child, View dependency) {
    ...
    private void maybeInitProperties(ShapedImageView child, View dependency) {
